...
const EditorPage = React.lazy(() => import('./src/pages/EditorPage').then(m => ({ default: m.EditorPage })));
const AdminPage = React.lazy(() => import('./src/pages/AdminPage').then(m => ({ default: m.AdminPage })));
...
const EditorRoute: React.FC = () => {
  ...
  if (hasSubdomain || hasWebsiteParam) {
    return <Suspense fallback={<PageLoader />}><EditorPage /></Suspense>;
  }
